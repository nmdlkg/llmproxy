...
func TestEnrichAuthSelectionError_IncludesUpstreamErrorFromCause(t *testing.T) {
	...
	out := (&BaseAPIHandler{}).enrichAuthSelectionError(in, []string{"codex"}, "gpt-5.6-sol")
...
func TestEnrichAuthSelectionError_DoesNotModifyModelCooldownError(t *testing.T) {
	...
	out := (&BaseAPIHandler{}).enrichAuthSelectionError(errPick, []string{"codex"}, "gpt-5.6-sol")
	if out != errPick {
...
func TestEnrichAuthSelectionError_PropagatesTerminalAuth(t *testing.T) {
	...
	enriched := (&BaseAPIHandler{}).enrichAuthSelectionError(terminalErr, []string{"codex"}, "gpt-5.6-sol")
